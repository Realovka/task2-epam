...
public class MedicineStaxBuilderTest {
    ...
    MedicineStaxBuilder medicineStaxBuilder;
    ...
    @Test
    public void testGetMedicines() throws MedicineException {
        Set<Medicine> resultSet = new HashSet<>();
        medicineStaxBuilder.buildMedicines(pathToXml);
        medicines = medicineStaxBuilder.getMedicines();
